...
+
image:express-c-series-c190-deploy_image4.png["OnCommand System Manager 支援設定的快照，包含 AutoSupport 和事件通知欄位"]
...
link:express-c-series-c190-deploy_deploy_cisco_ucs_c-series_rack_server.html["下一步：部署 Cisco UCS C 系列機架伺服器。"]
