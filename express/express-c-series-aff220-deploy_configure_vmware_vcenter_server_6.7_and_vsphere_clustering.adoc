...
. 按一下「確定」。
+
image:express-c-series-aff220-deploy_image49.png["已為叢集 Tiger3 啟用 DRS 和 vSphere HA 的 New Cluster 對話方塊快照"]
...
+
image:express-c-series-aff220-deploy_image50.png["vSphere Web Client 的快照，顯示 FlexPod 叢集動作選單，其中已選取「新增主機」。"]
