...
image:express-c-series-c190-design_image4.png["圖示為兩台 AFF C190 控制器的後視圖，控制器具有用於 SFP+ 模組的 UTA 2 連接埠"]

下圖說明透過傳統RJ-45乙太網路纜線進行連線的10GBASE-T連接埠。

image:express-c-series-c190-design_image5.png["圖示為具有 10GBASE-T RJ-45 連接埠的 AFF C190 系統後面板。"]
...
有關 AFF C190 硬體系統的完整資訊，請參閱 https://docs.netapp.com/us-en/ontap-systems/c190/install-setup.html["NetApp AFF C190 文件"^]。
...
image:express-c-series-c190-design_image6.png["一張圖表，展示了多個 4KB 邏輯區塊壓縮成一個 4KB 實體區塊的過程。"]
...
image:express-c-series-c190-design_image7.png["Cisco Nexus 31108PC-V 交換器的正面檢視，配備 48 個 SFP+ 連接埠和 6 個 QSFP28 連接埠"]
...
image:express-c-series-c190-design_image8.png["Cisco UCS C220 M5 機架伺服器正面檢視，配備雙磁碟機托架和 Cisco 品牌標識"]
...
image:express-c-series-c190-design_image9.png["一張 Cisco UCS VIC 1457 介面卡的快照，該介面卡帶有四個 SFP28 連接埠和一個散熱風扇。"]
...
image:express-c-series-c190-design_image10.png["一張示意圖，顯示了四個 vNIC 連接到 VMware ESXi 6.7 U2 主機上的 FlexPod 和 iSCSI 開機 vSwitches"]
