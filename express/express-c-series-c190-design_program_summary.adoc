...
image:express-c-series-c190-design_image1.png["一張圖表，比較 FlexPod Express 部門部署與 FlexPod Datacenter 關鍵任務工作負載。"]
...
image:express-c-series-c190-design_image2.png["一張圖表，展示了 FlexPod Express 儲存設備、交換器和伺服器的硬體選項"]
...
image:express-c-series-c190-design_image3.png["一張顯示 FlexPod Express 交換器、C220 M5 伺服器和 AFF C190 儲存設備連線的圖表"]
