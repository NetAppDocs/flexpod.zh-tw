...
image:express-direct-attach-aff220-deploy_image2.png["一張比較 FlexPod Express、FlexPod Datacenter 和 FlexPod Select 解決方案的圖表"]
...
image:express-direct-attach-aff220-deploy_image3.png["此圖展示了 FlexPod Express 伺服器、Nexus 交換器和 AFF 儲存設備的佈線，包括管理、資料、IP、叢集互連和 vPC 對等網路。"]
