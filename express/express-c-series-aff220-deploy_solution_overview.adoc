...
image:express-c-series-aff220-deploy_image3.png["此圖比較了 FlexPod Express、Datacenter 和 Select 解決方案、目標平台和基礎架構元件。"]
...
image:express-c-series-aff220-deploy_image4.png["一張顯示 Cisco Nexus 3172P 交換器、UCS C220 M5 伺服器和 AFF A220 儲存設備連接性的圖表"]
