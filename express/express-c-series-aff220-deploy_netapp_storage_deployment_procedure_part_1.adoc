...
+
image:express-c-series-aff220-deploy_image6.png["System Manager 引導式設定叢集組態欄位的快照，適用於兩個 HA 配對節點和授權"]
...
+
image:express-c-series-aff220-deploy_image7.png["OnCommand System Manager 支援設定的快照，包含 AutoSupport 和事件通知欄位"]
