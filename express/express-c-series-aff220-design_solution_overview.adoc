...
image:express-c-series-aff220-design_image3.png["一張圖表，展示 FlexPod Express 儲存設備、交換器及運算硬體系列及其組態選項。"]
...
image:express-c-series-aff220-design_image4.png["一張顯示 Cisco Nexus 3172P 交換器、UCS C220 M5 伺服器和 AFF A220 儲存設備連接性的圖表"]
