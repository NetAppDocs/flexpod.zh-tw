...
如需 AFF A220 硬體系統的詳細資訊，請參閱 https://www.netapp.com/aff-a-series/["A系列首頁AFF"^]。
...
image:express-c-series-aff220-design_image5.png["一張圖表，展示了多個 4KB 邏輯區塊壓縮成一個 4KB 實體區塊的過程。"]
...
image:express-c-series-aff220-design_image6.png["一張顯示磁碟分割情況的圖表，分割區分為根目錄、控制器 1 分割區和控制器 2 分割區。"]

以上僅列舉了幾項補充 FlexPod Express 解決方案的重要功能。有關 ONTAP 9.4 其他特性和功能的詳細資訊，請參閱 https://www.netapp.com/pdf.html?item=/media/7413-ds-3231-ontap-unified-data-storage-management.pdf["資料管理軟體資料表ONTAP"^]。另請參閱 NetApp http://docs.netapp.com/ontap-9/index.jsp["供應說明文件中心 ONTAP"^]，其中已更新以納入 ONTAP 9.4。
...
image:express-c-series-aff220-design_image7.png["一張快照顯示了 Cisco Nexus 3172 交換器的正面檢視及其網路連接埠。"]
...
image:express-c-series-aff220-design_image8.png["Cisco UCS C220 M5 機架伺服器正面檢視，配備雙磁碟機托架和 Cisco 品牌標識"]
...
image:express-c-series-aff220-design_image9.png["一款 Cisco UCS VIC 1387 介面卡，配備雙 QSFP+ 連接埠和散熱風扇"]
...
image:express-c-series-aff220-design_image10.png["Cisco CVR-QSFP-SFP10G QSFP 轉 SFP 介面卡模組的照片"]
