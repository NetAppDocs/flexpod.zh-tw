...
image:express-c-series-c190-deploy_image1.png["一張圖表展示了 FlexPod Express 和 FlexPod Datacenter 產品組合選項及其使用案例。"]
...
image:express-c-series-c190-deploy_image2.png["一張顯示 FlexPod Express 交換器、C220 M5 伺服器和 AFF C190 儲存設備連線的圖表"]
