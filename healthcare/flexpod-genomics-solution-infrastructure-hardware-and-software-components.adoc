...
image:flexpod-genomics-image6.png["一張圖表展示了 FlexPod 基因組學與 Cisco UCS、Nexus、MDS 和 NetApp AFF A700 的連結情況"]

下圖說明FlexPod 了有關纜線的資訊。

image:flexpod-genomics-image7.png["一張圖表顯示 FlexPod 基因組學在 UCS、Nexus、NetApp AFF 和 MDS 交換器之間的佈線情況"]
