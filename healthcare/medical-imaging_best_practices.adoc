...
image:medical-imaging_image8.png["一張顯示 AFF A300 節點及其 a0a 介面群組、VLAN 以及 NFS 和 iSCSI LIF 的圖表"]
...
* 使用名為  https://www.netapp.com/pdf.html?item=/media/17229-tr4015.pdf["SnapMirror"^] 的 NetApp 基於儲存陣列的複寫技術，而非基於 vSphere 的複寫。
