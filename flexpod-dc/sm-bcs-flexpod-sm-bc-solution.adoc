...
image:sm-bcs-image4.png["示意圖顯示 FlexPod 站台 A 和 B 之間的連接，延遲最高為 10 毫秒，以及位於站台 C 的 ONTAP Mediator。"]
...
image:sm-bcs-image5.png["一張顯示 Cisco UCS C240/C245、C220/C225、B200 和 X210c M6 伺服器的圖表"]
...
image:sm-bcs-image6.png["圖示為 UCS 2408、2304、2208XP、2204XP 和 UCSX 9108 模組的正面視圖"]
...
image:sm-bcs-image7.png["一張顯示 Cisco UCS FI 6454、64108、6324、6332 和 6332-16UP 型號前面板的示意圖"]
...
image:sm-bcs-image8.png["圖示為 Cisco UCS VIC 1440、1467、1455、1480、1477、1457、14825、14425 和 14000 型橋接卡。"]
...
image:sm-bcs-image9.png["圖中顯示了 Cisco Nexus 9336C-FX2、93180YC-FX3 和 3232C 交換器。"]
...
image:sm-bcs-image10.png["一張顯示 Cisco MDS 9132T、9148T、9148S、9250i 和 9396T 交換器正面視圖的圖表"]
...
image:sm-bcs-image11.png["圖中顯示了 NetApp AFF 和 ASA 控制器以及 DS 224C/2246 和 NS 224 磁碟櫃。"]
...
image:sm-bcs-image12.png["一張圖表，顯示兩個具有 SM-BC 關係的 FlexPod 站台，以及位於站台 C 的 ONTAP Mediator。"]
...
image:sm-bcs-image13.png["顯示透過擴展第 2 層鏈路和 ONTAP Mediator 連接的非對稱 FlexPod 站台的圖表"]
...
image:sm-bcs-image14.png["此圖顯示透過 VXLAN 多站台架構連接、且具有 SM-BC 關係的 Intersight 與 UCSM 管理的 FlexPod 站台。"]

對於在都會區內擁有資料中心和多個分公司的公司而言、所有這些都需要妥善保護、才能維持營運不中斷、 可實作下圖所示的《支援SM至BC部署拓撲》、以保護關鍵應用程式和資料服務、使所有分公司的RPO達到零、RTO目標幾乎為零。FlexPod

image:sm-bcs-image15.png["一張示意圖，顯示 FlexPod 分公司站台透過 VXLAN 多站台架構和 ONTAP Mediator 連接至資料中心。"]
