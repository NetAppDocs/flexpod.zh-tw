...
image:sm-bcs-image2.png["一張展示 FlexPod Datacenter 元件的圖表：Cisco UCS、Nexus/MDS 交換器以及 NetApp AFF/FAS/ASA 儲存設備"]
...
image:sm-bcs-image3.png["一張展示 SnapMirror 主資料中心和輔助資料中心之間同步複寫和自動故障轉移的圖表"]
