...
image:sm-bcs-image17.png["圖示為 UCS 2204XP A 和 B 透過 10GBASE-KR 連接到 B200 M5 VIC。"]
...
image:sm-bcs-image18.png["圖示顯示連接到 FI 6454 交換器以及 Nexus A 和 B 交換器的 UCS 5108 IOM。"]
...
image:sm-bcs-image19.png["快照顯示 Cisco UCS Manager「設定 iSCSI 開機參數」對話框，其中已設定兩個靜態目標。"]
