...
image:cloud-fabricpool_image6.png["一張示意圖，顯示兩個 NetApp AFF A300 控制器如何將叢集間 LIF 連接到 AWS S3。"]
...
image:cloud-fabricpool_image7.png["ONTAP CLI 物件存放區分析器結果的快照，顯示 PUT 和 GET 的延遲和處理量"]
