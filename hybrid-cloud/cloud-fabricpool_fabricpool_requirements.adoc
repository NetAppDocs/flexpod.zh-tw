...
NOTE: 請參閱 https://hwu.netapp.com/DetailViews/Home.aspx[] [NetApp Hardware Universe^] 以獲取有關支援 FabricPool 平台的最新資訊。

* NetApp ONTAP Select [NOTE] NetApp 建議使用全 SSD FabricPool 本機層。
* 雲端階層
+
