...
image:cloud-insights_image2.png["此圖顯示了透過網路連結互連的 Cisco UCS、Nexus 交換器、NetApp AFF A800 控制器和 MDS 交換器。"]
...
* 利用提供給 NetApp Digital Advisor 的資料分析環境，以評估儲存系統風險並提出儲存最佳化建議。
