...
FlexPod已獲得 EHR 認證，並支援包含Cisco UCS、Intel Xeon 處理器、Red Hat Enterprise Linux (RHEL) 和 VMware ESXiCisco化的平台。該平台，加上 EHR 對運行ONTAP的NetApp存儲的高舒適度評級，使您能夠通過FlexPod在完全託管的私有雲中運行您的醫療保健應用程序，該私有雲還可以連接到任何公共雲提供商。



== NetApp Console

NetApp Console是一個企業級的、基於 SaaS 的管理平台，它使 IT 專家和雲端架構師能夠使用NetApp雲端解決方案集中管理其混合多雲基礎架構。它提供了一個集中式系統，用於查看和管理您的本地和雲端存儲，支援混合雲、多雲提供者和帳戶。有關詳細信息，請參閱 link:https://docs.netapp.com/us-en/console-family/index.html["NetApp Console文檔"^]。



== 控制台代理

控制台代理實例使控制台能夠管理公有雲環境中的資源和程序。控制台提供的許多功能都需要控制台代理，它可以部署在雲端或本地網路中。
...
link:https://docs.netapp.com/us-en/console-setup-admin/concept-connectors.html["了解有關控制台代理的更多信息"^]。
...
更多詳細信息，請參閱link:https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/["Cloud Volumes ONTAP"^]。
...
有關詳細信息，請參閱 link:https://docs.netapp.com/us-en/active-iq-unified-manager/["Active IQ Unified Manager"^]。
...
有關 VMware vSphere 及其組件的更多信息，請參閱link:https://www.vmware.com/products/vsphere.html["VMware vSphere"^]。
...
詳細資訊請參見link:https://www.vmware.com/products/vcenter.html["VMware vCenter"^]。



== 硬體與軟體版本

這種混合雲解決方案可以擴展到任何執行受支援版本軟體、韌體和硬體的 FlexPod 環境，如 link:http://mysupport.netapp.com/matrix["NetApp 互通性對照表工具"^]、link:https://ucshcltool.cloudapps.cisco.com/public/["UCS硬體與軟體相容性"^] 和 link:https://www.vmware.com/resources/compatibility/search.php["VMware相容性指南"^] 中所定義。
...
|===
下表顯示了控制台和Cloud Volumes ONTAP版本。
