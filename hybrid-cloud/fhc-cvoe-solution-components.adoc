...
這種混合雲解決方案可以擴展到任何運行支援版本的軟體、韌體和硬體的FlexPod環境，具體定義見：link:http://support.netapp.com/matrix/["NetApp 互通性對照表工具"^] ，link:https://ucshcltool.cloudapps.cisco.com/public/["UCS硬體與軟體相容性"^] ， 和link:https://www.vmware.com/resources/compatibility/search.php["VMware相容性指南"^]。
