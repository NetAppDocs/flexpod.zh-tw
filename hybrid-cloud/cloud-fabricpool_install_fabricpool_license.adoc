...
image:cloud-fabricpool_image8.png["OnCommand System Manager「新增授權套件」對話方塊的螢幕截圖，包含「選擇檔案」和「新增」按鈕"]
...
image:cloud-fabricpool_image9.png["ONTAP System Manager 授權詳細資料的快照顯示，FabricPool 授權容量為 10 TB，目前容量為 0 位元組。"]
