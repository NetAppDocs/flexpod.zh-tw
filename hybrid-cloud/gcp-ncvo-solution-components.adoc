...
有關 Intersight 授權及每種授權所支援功能的詳細資訊，請參閱 https://intersight.com/help/saas/getting_started/licensing_requirements/lic_infra["請按這裡"^]。
...
在 Intersight 系統中申請 Intersight Assist 服務後，您可以使用「透過 Intersight Assist 申請」選項來申請終端設備。如需更多資訊，請參閱 https://intersight.com/help/saas/getting_started/overview["快速入門"^]。
