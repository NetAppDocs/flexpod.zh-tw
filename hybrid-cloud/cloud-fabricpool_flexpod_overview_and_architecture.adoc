...
image:cloud-fabricpool_image2.png["一張圖表，展示了 FlexPod 儲存設備、Cisco Nexus 和 MDS 交換器以及 Cisco UCS 系列，並附有連線指南。"]
...
image:cloud-fabricpool_image3.png["一張顯示 Cisco UCS、Nexus 93180YC-EX、AFF A300 和 MDS 9148S 連接的圖表"]
