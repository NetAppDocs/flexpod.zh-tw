...
* *FlexPod Datacenter。*此平台是一個易擴充的資料中心基礎架構，適用於企業工作負載和應用程式、虛擬化、AI/ML、資料庫、SAP HANA、VDI 以及公有雲和私有雲。FlexPod Datacenter 有其自身的規範，這些規範已記錄於 https://docs.netapp.com/us-en/flexpod/fp-def/dc-tech-spec_solution_overview.html["資料中心技術規格FlexPod"^]。
