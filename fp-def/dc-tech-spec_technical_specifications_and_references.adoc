...
| NetApp AFF 產品-A800 | https://docs.netapp.com/us-en/ontap-systems/a800/install-setup.html["解答A800平台文件AFF"] 


| NetApp AFF 解決方案 | https://docs.netapp.com/us-en/ontap-systems/a700/install-setup.html["VMware平台文件AFF"] 


| NetApp AFF 產品系列A700s | https://docs.netapp.com/us-en/ontap-systems/a700s/install-setup.html["《Se A700s Platform Documentation》（《Se A700 AFF"] 


| NetApp AFF 產品-A400 | https://docs.netapp.com/us-en/ontap-systems/a400/install-setup.html["VMware平台文件AFF"] 


| NetApp AFF 產品-A250 | https://docs.netapp.com/us-en/ontap-systems/a250/install-setup.html["VA250平台文件AFF"] 
|===
...
NetApp 磁碟機櫃的技術規格包括尺寸規格大小、每個機箱的磁碟機數量以及機櫃 I/O 模組；這些文件可在下表中找到。如需更多資訊，請參閱 https://www.netapp.com/data-storage/disk-shelves-storage-media/["NetApp磁碟櫃與儲存媒體技術規格"^]和 https://hwu.netapp.com/["NetApp Hardware Universe"^]。
