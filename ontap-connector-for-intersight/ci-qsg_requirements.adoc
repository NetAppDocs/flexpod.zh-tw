...
NOTE: 有關 Cisco UCS 計算元件和 UCSM 版本的最低要求，請參閱 https://intersight.com/help/saas/supported_systems/overview["Cisco Intersight 支援的系統"^]。
...
如需瞭解各種授權層級所涵蓋功能的詳細資訊，請前往 https://intersight.com/help/saas/getting_started/licensing_requirements/lic_infra["基礎架構服務授權"^]。
