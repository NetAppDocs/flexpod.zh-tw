...
. 請至  https://software.cisco.com/download/home/286319499/type/286323047/release/1.1.7-0.a["software.cisco.com"^] 下載 Cisco Intersight Virtual Appliance。如需更多資訊，請前往  https://www.cisco.com/c/en/us/td/docs/unified_computing/Intersight/b_Cisco_Intersight_Appliance_Getting_Started_Guide/b_Cisco_Intersight_Appliance_Install_and_Upgrade_Guide_chapter_00.html["Intersight Appliance安裝與升級指南"^]。
...
. 部署後的Intersight輔助設備。
+
.. 瀏覽至 `https://<FQDN-of-your-appliance>`以完成設備的安裝後設定。
+
